# C++ STL Quick Help
    ...
    1.  It contains C++ STLs usage and quick help with easy to understand comments and examples (copy+paste to use).
    2.  I learned these while solving different kinds of Leetcode Questions.  
    3.  I will be using "int, string etc" for ease and not complex entities like pairs, structs etc 😉. You can replace it with any data structure.
    4.  If you are confused with the syntax or description, see the example. I am sure that will clear things BECAUSE I have specifically chosen  
        :mag_right: "EASY + IMPORTANT + MOST USED" examples.
    5.  Last but not least, I have added Leetcode Qns also which can be easily solved using STLs.
