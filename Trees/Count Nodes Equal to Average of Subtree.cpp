/*    Leetcode Problem No.: 2265. Count Nodes Equal to Average of Subtree    */
...
public:
    ...
    int sum(TreeNode* root, int &count) {
        ...
        int leftSideSum = sum(root->left, count);
        int rightSideSum = sum(root->right, count);
        
        return leftSideSum + rightSideSum + root->val;
    }
...
/*
    YOUTUBE VIDEO ON THIS Qn : https://www.youtube.com/watch?v=Y4UGaLpSqCg
*/