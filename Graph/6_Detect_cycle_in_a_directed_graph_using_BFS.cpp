...
class Solution {
    ...
    bool isCyclic(int N, vector<int> adj[]) {
        ...
        if (count == N) { // we visited all nodes, i.e., no cycle is present in a graph
            return false;
        } else { // we visited all nodes, i.e., cycle is present in a graph
            return true;
        }
...
/*
    YOUTUBE VIDEO ON THIS Qn : https://www.youtube.com/watch?v=74suJP4bwf0