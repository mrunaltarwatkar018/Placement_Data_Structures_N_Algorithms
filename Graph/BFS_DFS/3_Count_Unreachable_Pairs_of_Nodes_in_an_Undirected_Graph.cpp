...
public:
    ...
    void bfs(int u, unordered_map<int, vector<int>> &adj, vector<bool>& visited, long long &sizeOfComponent) {
    ...
    long long countPairs(int n, vector<vector<int>>& edges) {
        ...
        for(int i = 0; i<n; i++) {
            ...
            if(!visited[i]) {
                ...
                bfs(i, adj, visited, sizeOfComponent);
...
/*
        YOUTUBE VIDEO ON THIS Qn : https://www.youtube.com/watch?v=kOt2VNsU0FE
*/