/* Leetcode Problem No.: 1345. Jump Game IV */
...
public:
    int minJumps(vector<int>& arr) {
        ...
        for ( int i = 0; i < n; i++ ) {
            mp[arr[i]].push_back(i); // number -> { index1, index2, ... }
        }
...
/*
    ...
    Why BFS ?
        ...
        With BFS you can stop as soon as you reach the goal. With DFS you might reach the goal 
        (or memoize any result) via a sub-optimal path.

        To be sure you get the optimal solution with DFS, you can't use memoization because you 
        might still find a shorter path at any point in the future.
*/
//Approach-2 (DFS - TLE)
class Solution {
public:
...
/*
    YOUTUBE VIDEO ON THIS Qn : https://www.youtube.com/watch?v=tr1WHelOhJU
*/