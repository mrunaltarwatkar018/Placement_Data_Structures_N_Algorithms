/* Leetcode Problem No.: 1424. Diagonal Traverse II  */
...
public:
    vector<int> findDiagonalOrder(vector<vector<int>>& nums) {
        ...
        unordered_map<int, vector<int>> mp; // row + col, element
...
//S.C : O(sqrt(n)) -> O(not grater than max diagonal size )
class Solution {
public:
    vector<int> findDiagonalOrder(vector<vector<int>>& nums) {
...
/*
    YOUTUBE VIDEO ON THIS Qn : https://www.youtube.com/watch?v=5FWc--uZRwo
*/